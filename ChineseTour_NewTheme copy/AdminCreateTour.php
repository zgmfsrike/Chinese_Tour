...
<div class="container">
  ...
  <div class="row">
    <div class="col s12 l6" id="tour_description">
      <!--  Text : Tour name  -->
                  ...
                  if($result = mysqli_query($conn, $sql)){
                      if(mysqli_num_rows($result) > 0){
                          while($row = mysqli_fetch_array($result)){
                            ?>
                            <div>
                              <input type="checkbox" class="with-gap" name="accommodation[]" value="<?php echo $row['accommodation_id'];?>" id="<?php echo $row['accommodation_level'];?>" checked/>
