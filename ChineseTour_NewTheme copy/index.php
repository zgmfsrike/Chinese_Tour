...
<head>
    ...
    <div class="container">
        ...
        <br>
        <button type="button" onclick="window.location.href='index.php'" class="waves-effect waves-light btn amber" value="Back">Back</button>
        <br><br><br><br><br>
    </div>

    <?php    
    }else if($_GET['send_mail'] == 'unsuccessful'){
            ?>
    ...
    <div class="container">
        ...
        <h4>Sorry</h4>
        <br>
        <h5>Sending email is unsuccessful.</h5>
        <br>
        <button type="button" onclick="window.location.href='index.php'" class="waves-effect waves-light btn amber" value="Back">Back</button>
        <br><br><br><br><br>
    </div>
