...
<body>
      ...
      <div class="container">
        ...
        <div class="row col s12">
          <a href="AdminEditAboutUs.php" class="btn-floating tooltipped right btn-large waves-effect waves-light red" data-position="left" data-delay="50" data-tooltip="Edit"><i class="material-icons">edit</i></a>
        </div>
      </div>
