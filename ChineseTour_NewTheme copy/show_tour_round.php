        ...
        <h3>Tour Round</h3>
               ...
               if($_GET['tourId'] != ""){
                   ...
                   while($show = mysqli_fetch_array($result)) {
                     ...
                     echo "<td align ='center'><input class='waves-effect waves-light btn green' type='button' value='View' onclick=\"window.location.href='http://localhost:8080/ChineseTour/Chinese_Tour/ChineseTour_NewTheme%20copy/tour_round_member.php?tour_round_id=$tour_round_id'\"></td>";
                     echo "</tr>";
