...
//   }
// }
if(isset($temp) AND isset($submit) AND isset($m)){
...
if(isset($_POST['delete'])){
  $file = $target_dir . "home" . $_POST['delete'] . ".jpg";
  if (!unlink($file))
  {
    echo ("Error deleting $file");
    header("location: message.php?msg=deleteFail");
  }
  else
  {
    echo ("Deleted $file");
    header("location: admin_change_banners.php");
  }
