...
// }
 ...
 <!DOCTYPE html>
   <html>
 <?php
 $title = "Send mail to all tour member";
  ...
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="row s12 center">
        <button type="reset" value ="Reset" name ="reset" class="btn amber"/>Reset</button>
        <button type="submit" value ="Send" name ="send" class="btn green"/>Send</button>
      </div>
        <br>
      </form>
</div>
