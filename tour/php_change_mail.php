...
$acctive_url = "http://www.chiangmaihongthai.com/php_active_mail.php";
  ...
  if($_POST['save']){
    ...
    if( $count == 0 ){
      ...
      if(strcmp($email,$confirm_email)==0 && $oldmail !== $email){
        ...
        $url = $acctive_url . "?id=" . $id . "&u=" . md5($username)."&m=" .$email;
        ...
        try {
          ...
          for ($i = 0; $i< count($mail_array);$i++) {
            if($i==0){
              ...
              $mail->AddEmbeddedImage('component/footer_en-cn.png', 'footer');
              $body = "<center><p><img src='cid:header' /></p></center>";
              $body .= '<center><p><strong>You email address is changed</strong><br></p></center>';
              ...
              $body = "<center><p><img src='cid:header' /></p></center>";
              $body .= '<center><p><strong>You email address is changed</strong><br></p></center>';
              $body .= '<center><p><strong>Please confirm your E-mail</strong><br><strong>Link</strong> : '.$url.'</p></center>';
              $body .="<center><p><img src='cid:footer' /></p></center>";
              $mail->Body = $body;
              $mail->AltBody = strip_tags($body);
              $mail->send();
