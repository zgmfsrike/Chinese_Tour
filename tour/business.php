...
<ul class="collapsible">
  <li>
    <div class="collapsible-header"><?php echo $string_business_type1;?></div>
  ...
  <li>
    <div class="collapsible-header"><?php echo $string_business_type2;?></div>
    <div class="collapsible-body">
      <span>
  ...
  <li>
    <div class="collapsible-header"><?php echo $string_business_type3;?></div>
    <div class="collapsible-body">
      <span>
