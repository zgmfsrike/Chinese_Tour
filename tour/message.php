        ...
        if(isset($_GET['msg'])){
            ...
            switch ($msg) {
                ...
                case 'create_news_succ':
                    if(isset($_GET['id'])){
                        message('Success!','News has been created ','news.php?news_id='.$_GET['id'],'back to news page');
                    }else{
                ...
                case 'edit_news_succ':
                    if(isset($_GET['id'])){
                        message('Success!','News has been changed ','news.php?news_id='.$_GET['id'],'back to news page');
                    }else {
                        message('Request not found','','','');
                    }
                ...
                case 'create_tour_succ':
                    if(isset($_GET['id'])){
                        message('Success!','Create tour successfully','tour.php?id='.$_GET['id'],'Back to tour page');
                    }else{
                        message('Request not found','','','');
                    }
                    break;
                ...
                case 'edit_tour_succ':
                    if(isset($_GET['id'])){
                        message('Success!','Editing tour successfully','tour.php?id='.$_GET['id'],'Back to tour page');
                    }else{
                        message('Request not found','','','');
                    }
                    break;
