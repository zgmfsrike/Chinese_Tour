...
<ul class="collapsible">
  <li>
    <div class="collapsible-header tooltipped" data-position="left" data-delay="50" data-tooltip="Click Me!"><?php echo $string_convention_type1;?></div>
  ...
  <li>
    <div class="collapsible-header tooltipped" data-position="left" data-delay="50" data-tooltip="Click Me!"><?php echo $string_convention_type2;?></div>
    <div class="collapsible-body">
      <span>
  ...
  <li>
    <div class="collapsible-header tooltipped" data-position="left" data-delay="50" data-tooltip="Click Me!"><?php echo $string_convention_type3;?></div>
    <div class="collapsible-body">
      <span>
