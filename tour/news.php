...
<body>
  ...
  if($_GET['news_id'] != ""){
    ...
    $sql= "SELECT n.news_id,n.topic,n.content FROM news_".$_COOKIE['lang']." n WHERE n.news_id = '$news_id'";
  ...
  $(document).ready(function(){
    ...
    $('.delete_warn').click(function(e){
      ...
      swal({
        ...
        confirmButtonText: '<a style="color:white" href ="admin_delete_news.php?news_id=<?php echo $news_id; ?>">Yes, delete it!</a>'
      }).then((result) => {
        if (result.value) {
          swal(
            // let url = getElementById('del_button').innerHTML = "<a href ='admin_delete_news.php?news_id=<?php echo $news_id; ?>'></a>";

            // '<a href ="admin_delete_news.php?news_id=<?php echo $news_id; ?>">Deleted</a>!'
